...
# get the threshold
# t_00 = al.get_threshold_subject("/media/cluster/data1/lambert/results/thresholds/", "voetbal")
# t_01 = al.get_threshold_subject("/media/cluster/data1/lambert/results/thresholds/", "moslim")
#
#
# # Use the threshold to get more polished datasets using the probabilities
# dset.save_meta_dataset( "/media/cluster/data1/lambert/datasets/meta_subjects/", dset.all_vectors_store, "voetbal", 0, t_00)
# dset.save_meta_dataset( "/media/cluster/data1/lambert/datasets/meta_subjects/", dset.all_vectors_store, "moslim", 1, t_01)
...
# nn.train_nn("/media/cluster/data1/lambert/results/meta_subjects/", dataset, 0)
...
# nn.train_nn("/media/cluster/data1/lambert/results/meta_subjects/", dataset, 1)
...
for i, hashtag in enumerate(dset.all_hashtags):
	...
	nn.train_nn("/media/cluster/data1/lambert/results/seeds/", dataset, i)
	...
	# seed_hashtag = "werk"
	threshold = al.get_threshold_subject("/media/cluster/data1/lambert/results/thresholds/", seed_hashtag)
	#
	...
	nn.train_nn("/media/cluster/data1/lambert/results/meta_subjects/", nn_data, i)
